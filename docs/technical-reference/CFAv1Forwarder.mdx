...
For more information on the best practices regarding this interaction, please refer to the [Interact Off-Chain](docs/protocol/money-streaming/guides/money-streaming-with-super-tokens/interact-off-chain.mdx) section of this documentation.
