...
For more information on the best practices regarding this interaction, please refer the [Interact Off-Chain](docs/protocol/money-streaming/guides/money-streaming-with-super-tokens/interact-off-chain.mdx) section of this documentation.
...
| :------------- | :------------------- | :--------------------------------------------------- |
| `token`        | contract ISuperToken | Super token address                                  |
| `sender`       | address              | The account which (possiby) granted permissions      |
