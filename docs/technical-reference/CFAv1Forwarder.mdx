...
It is a contract specifically made immutable in order to facilitate the interaction with [Payment Streams](/docs/protocol/money-streaming/overview.mdx) through the Constant Flow Agreement (CFA).
