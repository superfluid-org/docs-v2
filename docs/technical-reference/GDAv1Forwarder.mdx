...
This contract is optimized for interaction that would happen from ourside the blockchain (off-chain).
For more information on the best practices regarding this interaction, please refer the [Interact Off-Chain](/docs/protocol/distributions/guides/distributions-and-super-tokens/off-chain.mdx) section of this documentation.
...
<BonadocsWidget
  widgetConfigUri="ipfs://bafkreihiu63jpljsuycq3se6pq6jiconnlu6ewrmuzusacws5wpmmwbgye"
  contract="GDAv1Forwarder"
  functionKey="0x0779d365"
/>
