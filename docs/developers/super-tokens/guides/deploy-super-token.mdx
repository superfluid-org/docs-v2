...
Learn more about Wrapper Super Tokens in the [Types of Super Tokens](../types-of-super-tokens.md#1.-wrapper-super-tokens) section.
...
Locate the new Super Token's address in the "SuperTokenCreated" event log. To add your Super Token to the [Superfluid Dashboard](https://app.superfluid.finance/), follow the [token dashboard submission guidelines](../../../resources/token-dashboard-submission.md).
