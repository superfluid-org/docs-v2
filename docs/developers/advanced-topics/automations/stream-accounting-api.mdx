...
<div style={{ textAlign: 'center', margin: '20px' }}>
  <a href="https://superfluidhq.notion.site/Using-the-Stream-Accounting-API-3d161745acfe4750acf43c546f84c724" target="_blank" rel="noopener noreferrer">
    <button class="button-50" role="button">Click here for full a guide on how to set up a Stream Accounting API Automation</button>
  </a>
</div>
