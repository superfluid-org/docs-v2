...
import PoolsVisualization from '@site/src/components/PoolsVisualization';
...
<Admonition type="info"> For more detailed information on the implementation and usage of `SuperTokenV1Library.sol`, refer to the [Superfluid developer documentation](https://docs.superfluid.finance/superfluid/developers/pools). </Admonition> 