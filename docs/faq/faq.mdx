...
## How do I know if I should use simple Payment Streams or Distribution Pools?
- Use Payment Streams if you want to stream money from one account to another.
...
- For Payment Streams: Use the `CFAv1Forwarder` contract. To learn more about how to use it, refer to [CFAv1Forwarder](/docs/technical-reference/CFAv1Forwarder.mdx).
