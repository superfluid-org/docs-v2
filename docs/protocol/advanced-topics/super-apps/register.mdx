...
2. You can do this via the Superfluid Console:
   - Go to the "protocol" section (e.g., [Polygon Mainnet Console](https://console.superfluid.finance/matic/protocol))
   - Click the Explorer link for "Host"
   - Navigate to Contract -> Read as Proxy
   - Expand "WHITE_LISTING_ENABLED"

![Superfluid Console Screenshot](https://github.com/superfluid-finance/protocol-monorepo/assets/5479136/442b460c-d1e9-419e-8483-12235ca19f0a)
