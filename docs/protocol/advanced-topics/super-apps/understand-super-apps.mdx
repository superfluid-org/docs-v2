...
Super Apps are smart contracts registered with the Superfluid Protocol, allowing them to **react to Super Agreements** (like payment streams). They are similar to ERC777 hooks but for Super Agreements.
