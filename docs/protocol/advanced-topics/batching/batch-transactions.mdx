...
extends the capabilities of the Host by allowing a trusted forwarder to pass the original `msg.sender` to the host contract through the method `call`.
...
## How to use the Vanilla Macro Forwarder
