...
<div style={{ textAlign: 'center', margin: '20px' }}>
   <Button variant="contained" style={{ backgroundColor: 'green', fontSize: '16px', padding: '10px 20px' }} component={Link} to="https://superfluidhq.notion.site/Setting-Up-Stream-Scheduling-551888de690e402caee50e8d87cb6930">Click here for full a guide on how to set up a Stream Scheduler Automation</Button>
</div>
