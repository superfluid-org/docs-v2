...
<div style={{ textAlign: 'center', margin: '20px' }}>
  <a href="https://superfluidhq.notion.site/Setting-Up-Stream-Scheduling-551888de690e402caee50e8d87cb6930" target="_blank" rel="noopener noreferrer">
    <button class="button-50" role="button">Click here for full a guide on how to set up a Stream Scheduler Automation</button>
  </a>
</div>