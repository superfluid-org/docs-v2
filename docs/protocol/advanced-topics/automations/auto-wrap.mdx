...
<div style={{ textAlign: 'center', margin: '20px' }}>
   <Button variant="contained" style={{ backgroundColor: 'green', fontSize: '16px', padding: '10px 20px' }} component={Link} to="https://www.notion.so/superfluidhq/Setting-Up-Superfluid-Auto-Wrap-9a565d53bbee4bdc953cc2a656c43761">Click here for full a guide on how to set up an Auto-Wrap Automation</Button>
</div>
