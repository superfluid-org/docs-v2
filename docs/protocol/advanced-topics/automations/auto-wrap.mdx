...
<div style={{ textAlign: 'center', margin: '20px' }}>
  <a href="https://www.notion.so/superfluidhq/Setting-Up-Superfluid-Auto-Wrap-9a565d53bbee4bdc953cc2a656c43761" target="_blank" rel="noopener noreferrer">
    <button class="button-50" role="button">Click here for full a guide on how to set up an Auto-Wrap Automation</button>
  </a>
</div>
