...
<div style={{ textAlign: 'center', margin: '20px' }}>
   <Button variant="contained" style={{ backgroundColor: 'green', fontSize: '16px', padding: '10px 20px' }} component={Link} to="https://superfluidhq.notion.site/Using-the-Stream-Accounting-API-3d161745acfe4750acf43c546f84c724">Click here for full a guide on how to set up a Stream Accounting API Automation</Button>
</div>
