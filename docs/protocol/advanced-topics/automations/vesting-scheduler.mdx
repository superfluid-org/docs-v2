...
<div style={{ textAlign: 'center', margin: '20px' }}>
   <Button variant="contained" style={{ backgroundColor: 'green', fontSize: '16px', padding: '10px 20px' }} component={Link} to="https://www.notion.so/superfluidhq/Setting-Up-Automated-Vesting-f3e11a257a2d4b0b89210def54a59278">Click here for a full guide on Setting Up Automated Vesting</Button>
</div>
