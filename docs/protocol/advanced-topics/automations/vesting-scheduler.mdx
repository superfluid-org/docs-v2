...
<div style={{ textAlign: 'center', margin: '20px' }}>
  <a href="https://www.notion.so/superfluidhq/Setting-Up-Automated-Vesting-f3e11a257a2d4b0b89210def54a59278" target="_blank" rel="noopener noreferrer">
    <button class="button-50" role="button">Click here for a full guide on Setting Up Automated Vesting</button>
  </a>
</div>
