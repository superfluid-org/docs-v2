...
<div style={{ textAlign: 'center', margin: '20px' }}>
   <Button variant="contained" style={{ backgroundColor: 'green', fontSize: '16px', padding: '10px 20px' }} component={Link} to="https://superfluid.metabaseapp.com/public/dashboard/a074474a-3c03-4368-84f9-a87761f5d902">The Solvency Dashboard</Button>
</div>
