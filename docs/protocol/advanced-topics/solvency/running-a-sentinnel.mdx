...
**Sentinel**: A node that watches the Superfluid network & closes payment streams when they become critical or insolvent. Anyone can become a Sentinel by running a node
