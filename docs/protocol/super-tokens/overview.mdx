...
Super Tokens enhance the ERC20 token standard by integrating additional functionalities like streams and distributions (formarly termed as Super Agreements). Super Tokens exist in two primary forms: Wrapper and Pure.
...
Super Tokens offer a dynamic approach to balance calculation, incorporating both standard transfers and the ongoing effects of strems and distributions.

- **Static Balance**: Traditional ERC20 balance.
- **Real-Time Balances**: Fluctuations due to streams and distributions, either positive or negative.
