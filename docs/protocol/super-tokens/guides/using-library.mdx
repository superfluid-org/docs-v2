...
[Payment Streams](/docs/protocol/money-streaming/overview) (also called *Constant Flow Agreement* or *CFA*)
...
1. **Constant Flow Agreement (CFA)**: This represents Payment Streams functionality.
...
### Payment Streams (CFA) Functions

The library provides a wide range of functions for managing payment streams, including creating, updating, and deleting flows. For example:
...
This function creates a new payment stream. You can omit the `userData` parameter if not needed.
