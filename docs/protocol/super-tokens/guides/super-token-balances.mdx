...
To accurately track Super Token balances, you can use the queries below to get inflows and ouflow object from Superfluid's [Subgraph](https://console.superfluid.finance/subgraph).
