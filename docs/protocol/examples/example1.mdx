...
- [Payment Streams](/docs/protocol/money-streaming/overview)
...
- **Continuous Funds Stream**: Utilizing Superfluid's payment streaming concept, funds flow continuously into a distribution pool.
