...
# Example 1: FlowSplitter Smart Contract
...
For more details on the functions and features of the `FlowSplitter`, refer to the smart contract code and the Superfluid documentation.