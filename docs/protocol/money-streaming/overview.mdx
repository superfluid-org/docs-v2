...
# Payment Streams in Superfluid

Payment Streams, previously known as Constant Flow Agreement (CFA), revolutionize the movement of tokens with a by-the-second transfer mechanism. This page provides an in-depth overview of Payment Streams and the unique aspects of Flow NFTs in the Superfluid ecosystem.

## What are Payment Streams?

Payment Streams allow for continuous, per-second token transfers between accounts, offering a dynamic and flexible approach to token distribution.
...
For a more conceptual breakdown, refer to the [detailed Payment Streams overview](/docs/protocol/money-streaming/overview.mdx).

## Flows and Flow Rates

Payment Streams in Superfluid introduce the concepts of flows and flow rates, key elements for managing the continuous movement of tokens. This section defines these concepts and explains how to calculate flow rates accurately.
...
This section provides a clear understanding of flows and flow rates within Superfluid Payment Streams, enabling users to accurately manage and interpret their token streams.