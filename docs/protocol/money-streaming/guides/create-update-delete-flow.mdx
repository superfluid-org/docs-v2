...
- How to create flows by interacting with the Payment Stream Forwarder contract from client applications. For that please refer to the [SDK section](/docs/sdk/money-streaming/create-update-delete-flow).
