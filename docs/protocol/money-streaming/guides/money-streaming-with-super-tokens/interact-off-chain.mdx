...
This guide covers the basics of interacting with the `CFAv1Forwarder` contract using Ethers.js.

For more detailed information and advanced use cases, refer to the The CFAv1Forwarder [Technical Reference](/docs/technical-reference/CFAv1Forwarder).