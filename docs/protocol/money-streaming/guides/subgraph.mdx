...
The Superfluid Console is an interactive interface for exploring the Superfluid Protocol and interacting with its Subgraph. It provides an intuitive way to query on-chain data, get contract addresses, and manage your Superfluid finances. The console supports various blockchain networks, allowing you to seamlessly switch between them and access specific data sets. Whether you're analyzing streams, checking balances, or staying up to date with the new deployments. The Superfluid Console makes these tasks accessible and straightforward.
...
<Tabs
  ...
  <TabItem value="popular">
    <div style={{ display: 'flex', justifyContent: 'space-around', flexWrap: 'wrap' }}>
      <Button variant="contained" style={{ backgroundColor: 'green' }} component={Link} to="https://console.superfluid.finance/subgraph?\_network=ethereum">Ethereum</Button>
      <Button variant="contained" style={{ backgroundColor: 'green' }} component={Link} to="https://console.superfluid.finance/subgraph?\_network=matic">Polygon</Button>
      <Button variant="contained" style={{ backgroundColor: 'green' }} component={Link} to="https://console.superfluid.finance/subgraph?\_network=avalanche">Avalanche</Button>
      <Button variant="contained" style={{ backgroundColor: 'green' }} component={Link} to="https://console.superfluid.finance/subgraph?\_network=optimism">Optimism</Button>
      <Button variant="contained" style={{ backgroundColor: 'green' }} component={Link} to="https://console.superfluid.finance/subgraph?\_network=arbitrum">Arbitrum</Button>
      <Button variant="contained" style={{ backgroundColor: 'green' }} component={Link} to="https://console.superfluid.finance/subgraph?\_network=binance-smart-chain">Binance Smart Chain</Button>
    </div>
  </TabItem>
  <TabItem value="other">
    <p>For other networks, use the Superfluid Console:</p>
    <Button variant="contained" style={{ backgroundColor: 'green' }} component={Link} to="https://console.superfluid.finance/">Superfluid Console</Button>
...
- **Apollo Client**: [For Frontend Queries](https://www.apollographql.com/docs/)
