...
- The [Superfluid Simple Vesting Contract Repository](https://github.com/superfluid-finance/superfluid-quickstart)
...
## Contract Overview: SuperfluidVesting
...
<div>
<details>
<summary>Click here to show `SuperfluidVesting` contract</summary>
<p>
...
After cloning the [Superfluid Vesting Repository](https://github.com/superfluid-finance/superfluid-quickstart), you can test and deploy the contract with the following commands:
...
1. **Setup (`setUp` function)**:
   ...
   - Creates our `SuperfluidVesting` contract
