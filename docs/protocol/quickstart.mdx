...
One of them allows to create second-by-second token transfers (called [Payment Streams](/docs/protocol/money-streaming/overview.mdx)).
...
- Create, update or delete payment streams
...
- This contract is designed to interact with the Superfluid protocol, specifically to deploy a [Super Token](/docs/protocol/super-tokens/overview) and use [Payment Streams](/docs/protocol/money-streaming/overview.mdx).
- The contract enables the deployment of a Mock Super Token in the constructor.
- This contract enables the creation, modification, and deletion of continuous payment streams to the a recipient.
...
2. **Build Smart Contracts**:
   - [Payment Streams Overview](/docs/protocol/money-streaming/overview)
