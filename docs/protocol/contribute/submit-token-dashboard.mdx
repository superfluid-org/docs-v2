...
# Token Console Submission

You want your token to show up on the [Superfluid Console](https://console.superfluid.finance/)? Look no further.
In order to list a new token on the [Superfluid Console](https://console.superfluid.finance/) and have it visible in our Dashboard, please follow the steps below.
...
The Superfluid team will use the informations from the issue to add the token to the Console and to our protocol resolver. Hang tight!
