...
The GDA is the name of the impelmentation in our codebase. If you are interesed in the technical details, you can find the full Superfluid Architecture [here](/docs/technical-reference/Architecture).
:::
