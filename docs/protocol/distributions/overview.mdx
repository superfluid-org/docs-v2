...
import DistributionAnimation from "@site/src/components/DistributionAnimation";
...
Distributions is a Superfluid primitive that allows scalable are one-to-many or many-to-many transfer of value, in the form of discreet transfers or [Payment Streams](/docs/protocol/money-streaming/overview.mdx).
Superfluid's implementation of this concept allows for the creation of **Distribution Pools** with a designated **pool admin** who manages **units** for **pool members**.
...
- **Streaming Distribution**: They allow for continuous distribution of funds to receivers through [Payment Streams](/docs/protocol/money-streaming/overview.mdx) to a Pool.
...
<DistributionAnimation mode="instant" />
...
**Streaming Distributions allow for continuous distribution of funds to receivers through [Payment Streams](../money-streaming/overview.mdx) to a Pool.**

<DistributionAnimation mode="streaming" />
<div style={{ display: "flex", justifyContent: "center" }}>
  <p>
...
- **Distribution Pool**: Channels for proportional token distribution.
...
<DistributionAnimation mode="streaming" />
<div style={{ display: 'flex', justifyContent: 'center' }}>
    <p>*Visualization of payment streams from an external source to a Pool and its members*</p>
</div>
