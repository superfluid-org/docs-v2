...
<p><strong>Example:</strong> Converting a standard token to a Super Token and vice versa.</p>
...
<img src="./img/Pure.webp" alt="Pure Super Token Example" />
<p><strong>Example:</strong> $RIC by Ricochet DAO, a governance token deployed as a pure Super Token for extensive use of Super Agreements.</p>
