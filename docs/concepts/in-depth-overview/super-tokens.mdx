...
Super Tokens extend the [ERC20 token standard](https://ethereum.org/en/developers/docs/standards/tokens/erc-20/) with additional functionalities like [Money Streaming](./money-streaming.mdx) or [Distributions](./distributions.mdx), known as Super Agreements. There are two types of Super Tokens: wrapper and custom.
...
For more informations, about the wrapping process, please refer to our [Developers Section](/docs/developers/super-tokens/guides/deploy-super-token.mdx).
