...
The introduction of streaming distributions marks a significant advancement in web3, offering a scalable method for one-to-many fund transfers.

<Admonition type="info">
Distributions are currently active on testnets. Relevant addresses and tooling support are in progress, including additions to SuperTokenV1Library and SDK Core. For more information, visit the [Superfluid Console](https://console.superfluid.finance/eth-goerli/protocol).
</Admonition>

## Overview

Distributions allow for the creation of **pools** with a designated **pool admin** who manages **units** for **pool members**. Members of these pools can receive funds either instantly or through continuous streaming, making this method highly efficient and scalable.
