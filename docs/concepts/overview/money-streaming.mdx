...
_For more details, see the [Liquidations](/docs/developers/advanced-topics/solvency/liquidations-and-toga.mdx) and [Sentinels](/docs/developers/advanced-topics/solvency/running-a-sentinnel.mdx) pages._
