...
The Superfluid protocol is a designed to be a "token-centric" protocol, in that all of its functionalities revolve around the concept of [Super Tokens](./overview/super-tokens.mdx).
