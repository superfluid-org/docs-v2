...
- [***Money Streaming***](./overview/money-streaming.mdx) - An agreement that enables the creation of money streams between two parties.
- [***Distributions***](./overview/distributions.mdx) - An agreement that enables the creation of a pool of funds that can be distributed to multiple recipients.
