...
```bash
0x7f2f3685b5e0b7e4b4b5b1f3f7f5e1f6f3f3f3f3
```
...
:::tip NEW!
You can now use the MacroBuilder to generate your own UserDefinedMacro
for the most common operations. Check out the [MacrosBuilder](#macrosbuilder) below.
:::
...
To showcase how this works, we have a [`MacroFowarder` contract](https://sepolia-optimism.etherscan.io/address/0xfd017dbc8acf18b06cff9322fa6caae2243a5c95) deployed on OP Sepolia.
