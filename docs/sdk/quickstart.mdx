...
You'll learn how to connect your wallet, create payment streams, and create distribution pools using the Superfluid protocol.
...
1. For Payment Streams: Use the [`CFAv1Forwarder`](/docs/technical-reference/CFAv1Forwarder) contract
...
- Create a stream through the `CFAv1Forwarder` contract (for [Payment Streams](docs/concepts/overview/money-streaming))
...
5. Connect your wallet, then you can create payment streams and distribution pools using the Superfluid protocol.

This component provides a basic interface for creating payment streams and distribution pools. In a production environment, you would want to add more error checking, input validation, and additional features.
